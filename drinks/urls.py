...
urlpatterns = [
    ...
    path('order-items/', views.orderItemsDetails, name='orderItems-list'),
    path('orders/', views.allOrders, name='orders'),
    path('order-update/<slug:slugOrder>/', views.OrdersDetails, name='order-update'),
    path('customer/', views.customer, name='all-customers'),
